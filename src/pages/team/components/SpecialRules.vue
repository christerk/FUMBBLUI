    ...
    <div class="specialrules">
        <template v-if="! updateInProgress">
            ...
            <template v-else>
                ...
                <template v-for="(specialRuleLabel, index) in specialRuleLabels" :key="index">
                    <span>
                        ...
                        <template v-if="labelHasOptions(specialRuleLabel)">
                            <template v-if="showTeamOptions">
                                <select @change="changeTeamOption">
                                    ...
                                    <template v-for="specialRuleOption in teamOptions[specialRuleLabel]" :key="specialRuleOption">
