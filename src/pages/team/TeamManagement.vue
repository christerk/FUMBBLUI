<template>
    <div class="teammanagement">
        ...
        <modal
            ...
            :button-settings="{cancel: {enabled: false, label: ''}, confirm: {enabled: false, label: ''}}"
            :modal-size="'small'"
...
export default class TeamManagement extends Vue {
    ...
    public get teamReady(): boolean {
        return this.fumbblApi !== undefined && this.unexpectedErrorMessage === undefined && ! this.teamDeleted;
    }
